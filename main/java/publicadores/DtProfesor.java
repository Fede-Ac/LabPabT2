...
public class DtProfesor  extends publicadores.DtUsuario  implements java.io.Serializable {
    ...
    private publicadores.DtInstitucionDeportiva institucion;
    ...
    public DtProfesor(
           ...
           publicadores.DtInstitucionDeportiva institucion,
     ...
     * @return institucion
     */
    public publicadores.DtInstitucionDeportiva getInstitucion() {
        return institucion;
    }
     ...
     * @param institucion
     */
    public void setInstitucion(publicadores.DtInstitucionDeportiva institucion) {
        this.institucion = institucion;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://publicadores/", "dtInstitucionDeportiva"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
