...
<body>
	...
	<%
		...
		ArrayList<String> sociosEnClase = new ArrayList<String>();
		...
		for(DtUsuario U : socios){
			...
			for(DtClase C : dtC){
				if(a.getNombre() = C.getNombre()){
					sociosEnClase.add(U.getNombre());
				}
			}
		}
	%>
