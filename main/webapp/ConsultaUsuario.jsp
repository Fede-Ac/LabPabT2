        ...
        <div class="contenedor">
            <div class="contenedor2" >
                <div style="display:flex; flex-direction:row;">
                    ...
                    <div style="border-left: 3px solid #FF9B55; margin-top: auto; margin-bottom: auto; padding-left: 30px; flex-grow: 4;">
                        <div style="display:flex ;flex-direction:row-reverse;position: relative; top: -30px; right: -20px;">
                        ...
                        <div>
                            ...
                            <%if(dtu instanceof DtProfesor){ %>
	                            <div style="display:flex;">
	                                ...
	                                <p style="padding-left: 8px;font-size: 17px; margin-bottom: 0;"><%=((DtProfesor)dtu).getInstitucion().getNombre()%></p>
	                            </div>
	                            ...
	                            <div style="display:flex;">
	                                ...
	                                <p style="padding-left: 8px;font-size: 17px; margin-bottom: 0;"><%=((DtProfesor)dtu).getSitioWeb()%></p>
	                            </div>
	                            <%} %>
                            <%} %>
                        </div>
                ...
                <%if(dtu instanceof DtProfesor){ %>
	                ...
	                <div style="display:flex ;">
	                    <p style="margin:auto ; padding-right:19px ; font-size: 30px;">Biografía</p>
	            ...
	            <%} %>
                <div style="display:flex ;">
                    <p style="margin:auto ; padding-right:19px ; font-size: 30px;">Mis clases</p>
                    <%if(dtu instanceof DtProfesor){ %>
                    	<hr class="dashed col" style="margin-top: 23px;">
                    <%}else{ %>
                ...
                <div id="carouselExampleControls" style="width: 828px ; margin-left: auto;margin-right: auto;" class="carousel slide" data-bs-ride="carousel">
                  ...
                  <%} %>
                  <div style="display:flex ;">
                    <p style="margin:auto ; padding-right:19px ; font-size: 30px;">Mis actividades deportivas</p>
                    <hr class="dashed col" style="margin-top: 23px;">
                </div> <br> <br>
                <%
