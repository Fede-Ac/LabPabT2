            ...
            <div class="contenedor2">
                ...
                <div style="display: flex; justify-content:right; align-items: right;">
                    <button type="button" class="btn btn-primary btn-lg boton2 small ranking" data-bs-toggle="tooltip"
                        data-bs-placement="bottom" data-bs-title="Ordenar por no. de clases"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card custom-card" style="width: 16rem; margin-bottom: 30px;">
                                ...
                                <h5 class="card-title custom-card-title">Pesas</h5>
                                <div class="card-body">
    
                                    <p class="card-text p-small">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                        sed do
                                        eiusmod tempor.</p>
                                    <button type="button" class="btn btn-primary btn-lg boton2 small" data-bs-toggle="modal"
                                        data-bs-target="#modalClases">Ver clases</button>
    
                                    <div class="container">
                                        <div class="row">
                                            <div class="col" style="text-align:left; padding: 0;">
                                                <p class="p-small" style="margin: 0; margin-top: 10px;">2 hrs</p>
                                            </div>
    
                                            <div class="col" style="text-align:right;padding: 0;">
                                                <p class="p-small" style="margin: 0; margin-top: 10px;">$500</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <div class="card custom-card" style="width: 16rem; margin-bottom: 30px;">
                                <img style="height: 200px; object-fit:cover;"
                                    ...
                                    class="card-img-top" alt="...">
                                <h5 class="card-title custom-card-title">Tenis</h5>
                                <div class="card-body">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col" style="text-align:left; padding: 0;">
                                                <p class="p-small" style="margin: 0; margin-top: 10px;">3 hrs</p>
                                            </div>
    
                                            <div class="col" style="text-align:right;padding: 0;">
                                                <p class="p-small" style="margin: 0; margin-top: 10px;">$800</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <div class="card custom-card" style="width: 16rem; margin-bottom: 30px;">
                                <img style="height: 200px; object-fit:cover;"
                                    ...
                                    class="card-img-top" alt="...">
                                <h5 class="card-title custom-card-title">Volleyball</h5>
                                <div class="card-body">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col" style="text-align:left; padding: 0;">
                                                <p class="p-small" style="margin: 0; margin-top: 10px;">4 hrs</p>
                                            </div>
    
                                            <div class="col" style="text-align:right;padding: 0;">
                                                <p class="p-small" style="margin: 0; margin-top: 10px;">$700</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Clases de (Actividad Deportiva)</h1>
