					...
					<div class="row">
						...
						<div class="col">
							<div class="card custom-card" style="width: 16rem; margin-bottom: 30px;">
								<img style="height: 200px; object-fit: cover;" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShNq8TM2cSal04ik6zPi5I2KfJpoH9w2FTGw&usqp=CAU" class="card-img-top" alt="...">
																	...
																	<div class="card custom-card"
																		...
																		<div class="card-body"
																			...
																			<ul class="list-group list-group-flush">
																				...
																				<li class="list-group-item"
																					style="text-align: center; font-size: 13px; color: rgb(165, 165, 165);"><%=dtc.getFechaReg()%></li>
																				<li class="list-group-item" style="text-align: center; font-size: 13px; color: rgb(165, 165, 165);">
																					<a href="#">Ver más información</a> <!-- Completar CU  Consulta de Dictado de Clase -->
																				</li>
																			</ul>
																		</div>
																	</div>
