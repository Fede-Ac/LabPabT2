                            ...
                            <div class="card custom-card" style="width: 16rem; margin-bottom: 30px;">
                                ...
                                <div class="card-body">
    								<ul class="list-group list-group-flush">
                                        <li class="list-group-item" style="padding-top: 0;"> <p class="card-text p-small" style="text-align:center; margin-bottom:10px;"><%=descripcion %></p></li>
                                        <button type="button" class="btn btn-primary btn-lg boton2 small" data-bs-toggle="modal"
                                        data-bs-target="#modalClases" data-actividad="<%=nombre %>" onclick="document.getElementById('titulo').innerHTML='Clases de <%=nombre %>'; <%actividadActiva = icon.getDtActividadDeportiva(nombre);%>">Ver clases</button>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col" style="text-align:left; padding: 0;">
                                                <p class="p-small" style="margin: 0; margin-top: 0px;"><%=duracion %> hrs</p>
                                            </div>
    
                                            <div class="col" style="text-align:right;padding: 0;">
                                                <p class="p-small" style="margin: 0; margin-top: 0px;">$<%=costo %></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
