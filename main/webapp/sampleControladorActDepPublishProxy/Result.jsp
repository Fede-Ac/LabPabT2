...
case 287:
        gotMethod = true;
        publicadores.DtActividadDeportiva[] rankingActividadesDeportivas287mtemp = sampleControladorActDepPublishProxyid.rankingActividadesDeportivas();
if(rankingActividadesDeportivas287mtemp == null){
%>
<%=rankingActividadesDeportivas287mtemp %>
<%
}else{
        String tempreturnp288 = null;
        if(rankingActividadesDeportivas287mtemp != null){
        java.util.List listreturnp288= java.util.Arrays.asList(rankingActividadesDeportivas287mtemp);
        tempreturnp288 = listreturnp288.toString();
        }
        %>
        <%=tempreturnp288%>
        <%
